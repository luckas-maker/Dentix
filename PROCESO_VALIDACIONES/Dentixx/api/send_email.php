...
function sendActivationLinkEmail($recipient_email, $token) {
    ...
    try {
        ...
        $mail->Password   = 'pzmo cngr kyve rbgp'; // Tu contraseña de app
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;
        $mail->Port       = 465;

        $mail->setFrom('kevineliuth1234@gmail.com', 'Dentixx - Activación de Cuenta');
        $mail->addAddress($recipient_email);
...
function sendRecoveryCodeEmail($recipient_email, $code) {
    ...
    try {
        ...
        $mail->SMTPAuth   = true;
        $mail->Username   = 'kevineliuth1234@gmail.com'; 
        $mail->Password   = 'pzmo cngr kyve rbgp';
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;
        $mail->Port       = 465;
...
function sendAppointmentStatusEmail($recipient_email, $patient_name, $status, $cita_info) {
    ...
    try {
        ...
        $mail->setFrom('kevineliuth1234@gmail.com', 'Dentixx - Estado de Cita');
...
function sendNewAppointmentNotificationEmail($patient_name, $patient_email, $fecha_cita, $hora_cita) {
    $mail = new PHPMailer(true);
    $dentist_email = 'kevineliuth1234@gmail.com'; // Correo fijo del Odontólogo
    ...
    try {
        ...
        $mail->Host       = 'smtp.gmail.com'; 
        $mail->SMTPAuth   = true;
        $mail->Username   = 'kevineliuth1234@gmail.com'; // Tu correo de envío
        $mail->Password   = 'pzmo cngr kyve rbgp'; // Tu contraseña de aplicación
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;
        $mail->Port       = 465;

        // --- Configuración del Emisor y Receptor ---
        $mail->setFrom('kevineliuth1234@gmail.com', 'Sistema Dentixx'); // SE MODIFICARA MAS ADELANTE PARA EL CORREO DEL ODONTOLOGO
...
function sendAppointmentReminderEmail($recipient_email, $patient_name, $fecha_cita, $hora_cita) {
    $mail = new PHPMailer(true);
    $dentist_email = 'kevineliuth1234@gmail.com'; // Correo de envío
...
function sendCancellationToPatientEmail($recipient_email, $patient_name, $fecha_cita, $hora_cita) {
    ...
    try {
        ...
        $mail->setFrom('kevineliuth1234@gmail.com', 'Dentixx - Aviso de Cita');
        $mail->addAddress($recipient_email, $patient_name);
 ...
 * (Envía a kevineliuth1234@gmail.com)
 */
function sendCancellationToDentistEmail($patient_name, $patient_email, $fecha_cita, $hora_cita, $motivo) {
    ...
    try {
        ...
        $mail->setFrom('kevineliuth1234@gmail.com', 'Sistema Dentixx');
        $mail->addAddress($dentist_email, 'Odontólogo Dentixx');
...
function sendMissedAppointmentEmail($recipient_email, $patient_name, $fecha_cita, $hora_cita) {
    ...
    try {
        ...
        $mail->setFrom('kevineliuth1234@gmail.com', 'Dentixx - Aviso de Inasistencia');
        $mail->addAddress($recipient_email, $patient_name);
...
function sendAccountBlockedEmail($email, $nombre, $citas_canceladas = false) {
    ...
    try {
        ...
        $mail->Username = 'kevineliuth1234@gmail.com'; $mail->Password = 'pzmo cngr kyve rbgp';
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS; $mail->Port = 465;

        $mail->setFrom('kevineliuth1234@gmail.com', 'Seguridad Dentixx');
