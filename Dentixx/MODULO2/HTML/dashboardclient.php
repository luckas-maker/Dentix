        ...
        <div class="container mx-auto px-4 py-4">
            <div class="flex justify-between items-center">
                <div class="flex items-center space-x-4">
                    <a href="#" onclick="loadContent('../../MODULO2/HTML/veragendas.php')">
                    ...
                    <nav class="hidden md:flex space-x-4 ml-8">
                        <button onclick="loadContent('../../MODULO2/HTML/miscitas.php')" class="text-white font-bold hover:text-gray-200 transition-colors">Mis citas</button>
                        <button onclick="loadContent('../../MODULO2/HTML/veragendas.php')" class="text-white font-bold hover:text-gray-200 transition-colors">Reservar citas</button>
                        <button onclick="loadContent('../../MODULO1/HTML/miperfil.php')" class="text-white font-bold hover:text-gray-200 transition-colors">Mi perfil</button>
                    </nav>
                </div>
                <div class="flex items-center space-x-4">
                    <button onclick="loadContent('../../MODULO1/HTML/miperfil.php')" class="bg-blue-600 hover:bg-blue-700 px-3 py-1 rounded text-sm transition-colors">
