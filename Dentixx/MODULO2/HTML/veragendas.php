            ...
            <div class="flex justify-between items-center">
                <div class="flex items-center space-x-4">
                    ...
                    <nav class="hidden md:flex space-x-4 ml-8">
                        <button onclick="window.location.href='miscitas.php'" class="text-white font-bold hover:text-gray-200 transition-colors">Mis citas</button>
                        <button onclick="window.location.href='veragendas.php'" class="text-white font-bold hover:text-gray-200 transition-colors">Reservar citas</button>
