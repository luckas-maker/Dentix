...
<body class="bg-gray-50">
        ...
        <div class="container mx-auto px-4 py-4">
            <div class="flex justify-between items-center">
                <div class="flex items-center space-x-4">
                    <a href="#" onclick="loadContent('../../MODULO1/HTML/miperfilodontologo.php')">
                    ...
                    <nav class="hidden md:flex space-x-4 ml-8">
                        <button onclick="loadContent('../../MODULO3/HTML/agenda.html')" class="text-white font-bold hover:text-gray-200 transition-colors">Agendar citas</button>
                        <button onclick="loadContent('../../MODULO3/HTML/citasolicitadas.html')" class="text-white font-bold hover:text-gray-200 transition-colors">Citas solicitadas</button>
                        <button onclick="loadContent('../../MODULO3/HTML/gestiondisponibilidad.html')" class="text-white font-bold hover:text-gray-200 transition-colors">Gestion de disponibilidad</button>
                        <button onclick="loadContent('../../MODULO3/HTML/historial.html')" class="text-white font-bold hover:text-gray-200 transition-colors">Historial de citas</button>
                    </nav>
                </div>
                <div class="flex items-center space-x-4">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            loadContent('../../MODULO1/HTML/miperfilodontologo.php');
        });
